...
var JRegisterService = com.jteam.exhibition.RegisterService;
var Register = com.jteam.exhibition.Register;
...
var RegisterService = function(j_val) {
  ...
  this.addRegister = function(register, resultHandler) {
    ...
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_registerService["addRegister(com.jteam.exhibition.Register,io.vertx.core.Handler)"](register != null ? new Register(new JsonObject(JSON.stringify(register))) : null, function(ar) {
      if (ar.succeeded()) {
        resultHandler(null, null);
      } else {
        resultHandler(null, ar.cause());
