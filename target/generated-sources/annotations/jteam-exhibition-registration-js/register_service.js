...
/** @module jteam-exhibition-registration-js/register_service */
var utils = require('vertx-js/util/utils');

var io = Packages.io;
var JsonObject = io.vertx.core.json.JsonObject;
var JRegisterService = Java.type('com.jteam.exhibition.RegisterService');
var Register = Java.type('com.jteam.exhibition.Register');
...
var RegisterService = function(j_val) {
  ...
  this.addRegister = function(register, resultHandler) {
    ...
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_registerService["addRegister(com.jteam.exhibition.Register,io.vertx.core.Handler)"](register != null ? new Register(new JsonObject(Java.asJSONCompatible(register))) : null, function(ar) {
      if (ar.succeeded()) {
        resultHandler(null, null);
      } else {
        resultHandler(null, ar.cause());
...
RegisterService._jclass = utils.getJavaClass("com.jteam.exhibition.RegisterService");
RegisterService._jtype = {
  accept: function(obj) {
    return RegisterService._jclass.isInstance(obj._jdel);
  },
  wrap: function(jdel) {
    var obj = Object.create(RegisterService.prototype, {});
    RegisterService.apply(obj, arguments);
    return obj;
  },
  unwrap: function(obj) {
    return obj._jdel;
...
RegisterService._create = function(jdel) {
  var obj = Object.create(RegisterService.prototype, {});
  RegisterService.apply(obj, arguments);
  return obj;
}
